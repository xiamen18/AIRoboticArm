...
export const COMMANDS: CommandDefinition[] = [
  ...
  },
  {
    ...
    schema: z.object({
      ...
      move_sample: z.object({ enabled: z.boolean(), test_area_x: optionalNumber, test_area_y: optionalNumber, tube_pick_height: optionalNumber, lift_height: optionalNumber, place_height: optionalNumber, test_area_tube_pick_height: optionalNumber, test_area_tube_lift_height: optionalNumber, test_area_tube_place_height: optionalNumber, save: z.boolean() }).strict(),
    ...
    defaults: {
      ...
      move_sample: { enabled: false, test_area_x: 500, test_area_y: 250, tube_pick_height: 80, lift_height: 40, place_height: 75, test_area_tube_pick_height: 95, test_area_tube_lift_height: 45, test_area_tube_place_height: 90, save: false },
